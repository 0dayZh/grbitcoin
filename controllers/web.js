...
exports.sendEmailIfNeeded = function *(next) {
  ...
  if (this.errors) {
    ...
    if (connection) {
      ...
      var html_body = yield this.render('email-templates/binded-premailer', { writeResp: false });
      ...
      if (!token) {
        ...
        var html_body = yield this.render('email-templates/bind-premailer', { writeResp: false });
